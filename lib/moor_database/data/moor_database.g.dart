...
class TaskData extends DataClass implements Insertable<TaskData> {
  ...
  factory TaskData.fromData(Map<String, dynamic> data, GeneratedDatabase db, {String? prefix}) {
  ...
  factory TaskData.fromJson(Map<String, dynamic> json, {ValueSerializer? serializer}) {
  ...
  TaskData copyWith({int? id, String? name, DateTime? date, bool? completed}) => TaskData(
        id: id ?? this.id,
        name: name ?? this.name,
        date: date ?? this.date,
  ...
  @override
  int get hashCode => $mrjf($mrjc(id.hashCode, $mrjc(name.hashCode, $mrjc(date.hashCode, completed.hashCode))));
...
class TaskCompanion extends UpdateCompanion<TaskData> {
  ...
  TaskCompanion copyWith({Value<int?>? id, Value<String>? name, Value<DateTime?>? date, Value<bool>? completed}) {
    return TaskCompanion(
      id: id ?? this.id,
      name: name ?? this.name,
      date: date ?? this.date,
...
class $TaskTable extends Task with TableInfo<$TaskTable, TaskData> {
  ...
  late final GeneratedColumn<int?> id =
      GeneratedColumn<int?>('id', aliasedName, true, typeName: 'INTEGER', requiredDuringInsert: false);
  final VerificationMeta _nameMeta = const VerificationMeta('name');
  late final GeneratedColumn<String?> name = GeneratedColumn<String?>('name', aliasedName, false,
      additionalChecks: GeneratedColumn.checkTextLength(minTextLength: 0, maxTextLength: 255),
      typeName: 'TEXT',
      requiredDuringInsert: true);
  final VerificationMeta _dateMeta = const VerificationMeta('date');
  late final GeneratedColumn<DateTime?> date =
      GeneratedColumn<DateTime?>('date', aliasedName, true, typeName: 'INTEGER', requiredDuringInsert: false);
  ...
  @override
  VerificationContext validateIntegrity(Insertable<TaskData> instance, {bool isInserting = false}) {
  ...
  TaskData map(Map<String, dynamic> data, {String? tablePrefix}) {
    return TaskData.fromData(data, _db, prefix: tablePrefix != null ? '$tablePrefix.' : null);
  }
